...
static void AES128_InvertKey (u32 *rdk, u32 *s_td0, u32 *s_td1, u32 *s_td2, u32 *s_td3, u32 *s_td4, u32 *s_te0, u32 *s_te1, u32 *s_te2, u32 *s_te3, u32 *s_te4)
{
...
static void AES128_encrypt (const u32 *in, u32 *out, const u32 *rek, u32 *s_te0, u32 *s_te1, u32 *s_te2, u32 *s_te3, u32 *s_te4)
{
  u32 s0 = in[0] ^ rek[0];
  u32 s1 = in[1] ^ rek[1];
  u32 s2 = in[2] ^ rek[2];
...
static void AES128_decrypt (const u32 *in, u32 *out, const u32 *rdk, u32 *s_td0, u32 *s_td1, u32 *s_td2, u32 *s_td3, u32 *s_td4)
{
  u32 s0 = in[0] ^ rdk[0];
  u32 s1 = in[1] ^ rdk[1];
  u32 s2 = in[2] ^ rdk[2];
